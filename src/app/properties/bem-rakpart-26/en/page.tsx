...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: en.meta.title,
    description: en.meta.description,
    url: "https://getluxsold.com/properties/bem-rakpart-26/en",
    siteName: "GetLuxSold",
    locale: "en_US",
    type: "website",
  },
  ...
  alternates: {
    canonical: "https://getluxsold.com/properties/bem-rakpart-26/en",
    languages: {
...
export default function BemRakpartEnglishPage() {
  return (
    <>
      <PropertyJsonLd
        name="Bem rakpart 26"
      ...
      <BreadcrumbJsonLd
        items={[
          { name: "GetLuxSold", url: "https://getluxsold.com/en" },
          { name: "Bem rakpart 26", url: "https://getluxsold.com/properties/bem-rakpart-26/en" },
        ]}
      />
      <PropertyPage dictionary={en} locale="en" basePath="/properties/bem-rakpart-26" propertyData={bemRakpart26} />
    </>
  );
}
