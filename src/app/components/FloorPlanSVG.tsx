...
const roomDescriptions: Record<Locale, Record<string, string>> = {
  ...
  zh: {
    ...
    A2: "客厅 – 连接阳台和中间房",
    A3: "中间房 – 连接阳台和客厅",
    A4: "浴室 – 带窗户，可见多瑙河和巴特亚尼广场。连接门厅和中间房",
    A5: "小阳台 – 朝东，可见巴特亚尼广场和教堂",
    A6: "门厅 – 西侧入口。连接中间房、浴室和过道",
    A7: "卫生间",
    A8: "过道 – 连接门厅、卫生间、储藏室和厨房",
    A9: "储藏室",
    A10: "厨房 – 连接小阳台和小房间",
    A11: "小房间 – 连接厨房",
  },
  he: {
    ...
    A2: "סלון – מחובר למרפסת ולחדר האמצעי",
    A3: "חדר אמצעי – מחובר למרפסת ולסלון",
    A4: "חדר אמבטיה – עם חלון, נוף לדנובה ולכיכר בטיאני. מחובר למבואה ולחדר האמצעי",
    A5: "מרפסת קטנה – פונה מזרחה, נוף לכיכר בטיאני ולכנסייה",
    A6: "מבואה – כניסה ממערב. מחוברת לחדר האמצעי, לחדר האמבטיה ולמעבר",
    A7: "שירותים",
    A8: "מעבר – מחבר את המבואה לשירותים, למחסן ולמטבח",
    A9: "מחסן",
    A10: "מטבח – מחובר למרפסת הקטנה ולחדר הקטן",
    A11: "חדר קטן – מחובר למטבח",
  },
  vi: {
    A1: "Ban công hướng sông Danube – toàn cảnh 180° ra Quốc hội, Cầu Margaret và Cầu Xích",
    A2: "Phòng khách – kết nối ban công và phòng giữa",
    A3: "Phòng giữa – kết nối ban công và phòng khách",
    A4: "Phòng tắm – có cửa sổ, nhìn ra sông Danube và Quảng trường Batthyány. Kết nối sảnh và phòng giữa",
    A5: "Ban công nhỏ – hướng đông, nhìn ra Quảng trường Batthyány và nhà thờ",
    A6: "Sảnh – lối vào từ phía tây. Kết nối phòng giữa, phòng tắm và hành lang",
    A7: "WC",
    A8: "Hành lang – kết nối sảnh với WC, kho và nhà bếp",
    A9: "Kho",
    A10: "Nhà bếp – kết nối ban công nhỏ và phòng nhỏ",
    A11: "Phòng nhỏ – kết nối nhà bếp",
  },
  ru: {
    A1: "Балкон с видом на Дунай – панорама 180° на Парламент, мост Маргит и Цепной мост",
    A2: "Гостиная – соединена с балконом и средней комнатой",
    A3: "Средняя комната – соединена с балконом и гостиной",
    A4: "Ванная комната – с окном, вид на Дунай и площадь Баттяни. Соединена с прихожей и средней комнатой",
    A5: "Малый балкон – восточная сторона, вид на площадь Баттяни и церковь",
    A6: "Прихожая – вход с запада. Соединена со средней комнатой, ванной и коридором",
    A7: "Туалет",
    A8: "Коридор – соединяет прихожую с туалетом, кладовой и кухней",
    A9: "Кладовая",
    A10: "Кухня – соединена с малым балконом и малой комнатой",
    A11: "Малая комната – соединена с кухней",
  },
};
